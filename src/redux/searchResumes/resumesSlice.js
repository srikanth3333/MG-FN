...
export const getReports = createAsyncThunk('reports/getReports', 
	async (payload, {getState}) => {
        console.log('on')
        return await axios.get(`${API_URL}/addReportsListData?page=${payload.page}&skillSet=${payload.skill}&experienceRel=${payload.rel}&experienceTotal=${payload.total}&startDate=${payload.startDate}&endDate=${payload.endDate}`)
        .then(res => {
            console.log(res)
